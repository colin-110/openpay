package com.openpay.settlement.config;
...
@EntityScan(basePackages = {"com.openpay.settlement", "com.openpay.outbox"})
@EnableJpaRepositories(basePackages = {"com.openpay.settlement", "com.openpay.outbox"})
